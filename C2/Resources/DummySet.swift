...
let testData2 = ActivityData(
    authorName: "Jake", authorImage: nil,
    timeSlot: .evening, tag: .tennis,
...
let testData3 = ActivityData(
    authorName: "Sophie", authorImage: nil,
    timeSlot: .evening, tag: .running,
...
let testData4 = ActivityData(
    authorName: "Ryan", authorImage: nil,
    timeSlot: .morning, tag: .running,
...
let testData5 = ActivityData(
    authorName: "Emma", authorImage: nil,
    timeSlot: .evening, tag: .running,
...
let testData6 = ActivityData(
    authorName: "Chris", authorImage: nil,
    timeSlot: .morning, tag: .swimming,
...
let testData7 = ActivityData(
    authorName: "Mia", authorImage: nil,
    timeSlot: .morning, tag: .hiking,
...
let testData8 = ActivityData(
    authorName: "Tom", authorImage: nil,
    timeSlot: .evening, tag: .hiking,
...
let testData9 = ActivityData(
    authorName: "Lily", authorImage: nil,
    timeSlot: .evening, tag: .surfing,
...
let testData10 = ActivityData(
    authorName: "Noah", authorImage: nil,
    timeSlot: .morning, tag: .surfing,
...
let testData11 = ActivityData(
    authorName: "Zoe", authorImage: nil,
    timeSlot: .evening, tag: .surfing,
...
let testData12 = ActivityData(
    authorName: "Ethan", authorImage: nil,
    timeSlot: .morning, tag: .bicycle,
...
let testData13 = ActivityData(
    authorName: "Lucas", authorImage: nil,
    timeSlot: .evening, tag: .gym,
...
let testData14 = ActivityData(
    authorName: "Olivia", authorImage: nil,
    timeSlot: .morning, tag: .pingpong,
...
let testData15 = ActivityData(
    authorName: "Ben", authorImage: nil,
    timeSlot: .evening, tag: .pingpong,
...
let testData16 = ActivityData(
    authorName: "Chloe", authorImage: nil,
    timeSlot: .morning, tag: .pingpong,
...
let testData17 = ActivityData(
    authorName: "Sam", authorImage: nil,
    timeSlot: .evening, tag: .badminton,
...
let testData18 = ActivityData(
    authorName: "Grace", authorImage: nil,
    timeSlot: .morning, tag: .gym,
